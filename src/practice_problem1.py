...
class Box(object):
    ...
    def __init__(self, contents, volume):
        ...
        self.contbeforereset=[]
        self.volbeforereset=0
    ...
    def shrink(self, new_volume):
        ...
        tempcont=self.contents
        s = ''
        self.contents=''
        for k in range(len(tempcont)):
            if len(self.contents) < self.volume:
                self.contents = self.contents + tempcont[k]
            else:
                s = s + tempcont[k]
    ...
    def reset(self):
        ...
        #    TIME ESTIMATE:   5 minutes.
        # --------------------------------------------------------------
        self.volbeforereset=self.volume
        self.contbeforereset=self.contbeforereset + [self.contents]
